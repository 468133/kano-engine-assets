#!/system/bin/sh
# kano_engine 云端部署脚本 v1.0.11 —— KANO_TRAFFIC 插件兜底路径(设备侧直连)执行
# 由插件 base64 -d 后以 sh 运行; 不依赖 set -e(busybox 兼容性), 每步显式判断
# v1.0.11: 台账全量恢复(历史天保留) + resetsys 命令(归档后 WAN 总流量归零)
DIR=/data/data/com.minikano.f50_sms
BIN=$DIR/kano_engine
VER=$DIR/kano_engine.ver
PID=$DIR/kano_engine.pid
CURL=$DIR/files/curl
MD5="3f5e800ca35acdfc4723d52b45785f7d"
...
ok=0
for U in \
  "https://cdn.jsdmirror.com/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.11.b64" \
  "https://jsd.onmicrosoft.cn/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.11.b64" \
  "https://cdn.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.11.b64" \
  "https://fastly.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.11.b64" \
  "https://gcore.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.11.b64" \
  "https://testingcf.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.11.b64" \
  "https://ghfast.top/https://raw.githubusercontent.com/468133/kano-engine-assets/main/binaries/kano_engine_v1.0.11.b64" \
  "https://ghproxy.net/https://raw.githubusercontent.com/468133/kano-engine-assets/main/binaries/kano_engine_v1.0.11.b64" \
; do
