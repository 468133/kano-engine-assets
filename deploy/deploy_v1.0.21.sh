#!/system/bin/sh
# kano_engine 云端部署脚本 v1.0.21 —— KANO_TRAFFIC 插件兜底路径(设备侧直连)执行
...
# v1.0.21: 台账补种 —— 升级首启无 sysdelta 文件时, 用按日台账 __wan__ "今天以前"的天补回 sysDelta/win_dev
DIR=/data/data/com.minikano.f50_sms
BIN=$DIR/kano_engine
VER=$DIR/kano_engine.ver
PID=$DIR/kano_engine.pid
CURL=$DIR/files/curl
MD5="bf95cc57001358cdf8c4abe2ffa9a2e7"
...
ok=0
for U in \
  "https://cdn.jsdmirror.com/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.21.b64" \
  "https://jsd.onmicrosoft.cn/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.21.b64" \
  "https://cdn.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.21.b64" \
  "https://fastly.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.21.b64" \
  "https://gcore.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.21.b64" \
  "https://testingcf.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.21.b64" \
  "https://ghfast.top/https://raw.githubusercontent.com/468133/kano-engine-assets/main/binaries/kano_engine_v1.0.21.b64" \
  "https://ghproxy.net/https://raw.githubusercontent.com/468133/kano-engine-assets/main/binaries/kano_engine_v1.0.21.b64" \
; do
