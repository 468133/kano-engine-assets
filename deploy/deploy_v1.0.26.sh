#!/system/bin/sh
# kano_engine 云端部署脚本 v1.0.26 —— KANO_TRAFFIC 插件兜底路径(设备侧直连)执行
# v1.0.26: 未归属追认归属 —— 归属失败期间(邻居表未学到/缓存未命中)记入未归属的字节, 该 IP 归属成功后
#         按方向移入设备累计+今日台账+同窗口计数, 未归属同步扣减: ND/ARP 追认窗口内的量不再永久挂账
#         (尽力减少未归属流量, 真机 v6 归属率偏低)
...
CURL=$DIR/files/curl
MD5="17d30cacd1904f262f78624ff3d6b84b"
...
ok=0
for U in \
  "https://cdn.jsdmirror.com/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.26.b64" \
  "https://jsd.onmicrosoft.cn/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.26.b64" \
  "https://cdn.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.26.b64" \
  "https://fastly.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.26.b64" \
  "https://gcore.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.26.b64" \
  "https://testingcf.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.26.b64" \
  "https://ghfast.top/https://raw.githubusercontent.com/468133/kano-engine-assets/main/binaries/kano_engine_v1.0.26.b64" \
  "https://ghproxy.net/https://raw.githubusercontent.com/468133/kano-engine-assets/main/binaries/kano_engine_v1.0.26.b64" \
; do
