#!/system/bin/sh
# kano_engine 云端部署脚本 v1.0.5 —— KANO_TRAFFIC 插件兜底路径(设备侧直连)执行
...
CURL=$DIR/files/curl
MD5="6e64534ec34f1d02d7ecb6e863d32f58"
...
ok=0
for U in \
  "https://cdn.jsdmirror.com/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.5.b64" \
  "https://jsd.onmicrosoft.cn/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.5.b64" \
  "https://cdn.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.5.b64" \
  "https://fastly.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.5.b64" \
  "https://gcore.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.5.b64" \
  "https://testingcf.jsdelivr.net/gh/468133/kano-engine-assets@main/binaries/kano_engine_v1.0.5.b64" \
  "https://ghfast.top/https://raw.githubusercontent.com/468133/kano-engine-assets/main/binaries/kano_engine_v1.0.5.b64" \
  "https://ghproxy.net/https://raw.githubusercontent.com/468133/kano-engine-assets/main/binaries/kano_engine_v1.0.5.b64" \
; do
...
# 6. 重启引擎(v1.0.5: 输出进日志; 存活判定看进程而非 pid 文件, 启动即崩能看出来)
