...
(async () => {
            ...
            <div class="collapse" id="collapse_traffic" data-name="close" style="height:0px;overflow:hidden;">
                <div class="collapse_box">
                    ...
                    <div style="margin-top:10px;font-size:10px;opacity:.45;text-align:center;">
                        v${PLUGIN_VERSION} · <a href="https://t.me/GUMU51" target="_blank" style="color:#38bdf8;text-decoration:none;">✈️ 问题反馈 @GUMU51</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    const applyResponsive = () => {
        ...
        // v21.1.10: 固定阈值 + 溢出实测双条件 —— 表格实际宽度超出容器就切田字排版, 不再允许左右滑动
        let tiny = w > 0 && w < 340;
        if (!tiny && w > 0 && w < 760) {
