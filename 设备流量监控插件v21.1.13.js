...
(async () => {
    ...
    mmContainer.insertAdjacentHTML("afterend", `
        <style>
            ...
            /* 小UI(田字): 左设备信息不动, 中间田字2x2(上/下/总/信号), 最右限速+删除 */
            #IFRAME_KANO_TRAFFIC.kano-tiny .kano-tbl tr.kano-tr { display:grid; grid-template-columns:minmax(0,1.05fr) minmax(0,0.8fr) minmax(0,0.8fr) auto; gap:1px 6px; padding:6px 4px; align-items:center; }
            ...
            #IFRAME_KANO_TRAFFIC.kano-tiny .kano-tbl tr.kano-tr td:nth-child(1) { grid-column:1; grid-row:1 / 3; }
            ...
            #IFRAME_KANO_TRAFFIC.kano-tiny .kano-tbl tr.kano-tr td:nth-child(6) { grid-column:2; grid-row:2; }
            #IFRAME_KANO_TRAFFIC.kano-tiny .kano-tbl tr.kano-tr td:nth-child(3) { grid-column:3; grid-row:2; text-align:right !important; }
            #IFRAME_KANO_TRAFFIC.kano-tiny .kano-tbl tr.kano-tr td:nth-child(7) { grid-column:4; grid-row:1 / 3; text-align:center !important; }
            #IFRAME_KANO_TRAFFIC.kano-tiny .kano-tbl .kano-mac { display:none !important; }
            #IFRAME_KANO_TRAFFIC.kano-tiny .kano-tbl tr.kano-tr td div[style*="height:3px"] { width:56px !important; }
            ...
            <div class="collapse" id="collapse_traffic" data-name="close" style="height:0px;overflow:hidden;">
                <div class="collapse_box">
                    ...
                    <div style="margin-top:10px;font-size:10px;opacity:.45;text-align:center;">
                        <span class="kano-kao" id="kano_kao"></span>v${PLUGIN_VERSION} · <a href="https://t.me/GUMU51" target="_blank" style="color:#38bdf8;text-decoration:none;">✈️ 问题反馈 @GUMU51</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    // v21.1.13: 页脚彩蛋 —— 三档UI各一组随机文案(文字+颜文字), 换档或每次加载重抽
    let _kaoGroup = '';
    const KAO_LINES = {
        big: ['( ﾟ▽ﾟ)/ 大屏就是爽，流量随便看', '¯\\_(ツ)_/¯ 流量都去哪了？往下看', '(⌐■_■) 正在用显微镜盯着每一字节', '( ♪ ) 没有在假装播放音乐，只是顺便统计流量'],
        mid: ['(・ω・) 平板视野良好', '(¬‿¬) 中杯也很能装', '(ᵔᴥᵔ) 不多不少，刚刚好', '( ♪ ) 没有在假装播放音乐，只是顺便统计流量'],
        tiny: ['◕‿◕ 小窗也有春天', '(ﾉ◕ヮ◕)ﾉ 麻雀虽小，流量不少', 'ಠ_ಠ 屏幕小了，统计没少', '(._.) 挤一挤，总能放下']
    };
    const pickKao = () => {
