...
(async () => {
    ...
    mmContainer.insertAdjacentHTML("afterend", `
        <style>
            ...
            /* 小UI(田字): 左设备信息(加宽), 中间田字(上/下/总量跨两列), 最右限速+删除; v21.1.14 去掉信号格 */
            #IFRAME_KANO_TRAFFIC.kano-tiny .kano-tbl tr.kano-tr { display:grid; grid-template-columns:minmax(0,1.5fr) minmax(0,0.45fr) minmax(0,0.45fr) auto; gap:1px 8px; padding:6px 4px; align-items:center; }
            ...
            #IFRAME_KANO_TRAFFIC.kano-tiny .kano-tbl tr.kano-tr td:nth-child(1) { grid-column:1; grid-row:1 / 3; padding-right:10px !important; }
