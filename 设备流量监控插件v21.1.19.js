...
(async () => {
    ...
    mmContainer.insertAdjacentHTML("afterend", `
        <style>
            ...
            /* 小UI(田字): 左设备信息 | 田字(上/下载各占半行、总量跨底行) | 最右限速上删除下竖排窄列; v21.1.19 按钮堆叠换田字加宽, 分割线左右等距 */
            #IFRAME_KANO_TRAFFIC.kano-tiny .kano-tbl tr.kano-tr { display:grid; grid-template-columns:minmax(0,1.4fr) minmax(0,1fr) minmax(0,1fr) auto; gap:1px 8px; padding:6px 4px; align-items:center; }
